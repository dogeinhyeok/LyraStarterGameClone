 ...
 */
UCLASS()
class LYRASTARTERGAMECLONE_API UAsyncAction_ExperienceReady : public UBlueprintAsyncActionBase
{
	GENERATED_BODY()
...
public:
	...
	void Step3_ListenToExperienceLoaded(const ULyraExperienceDefinition* CurrentExperience);
